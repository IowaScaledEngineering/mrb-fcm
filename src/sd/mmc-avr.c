...
#define CS_LOW()	PORTD &= ~_BV(SDCARD_CS_PIN)		/* CS=low */
#define	CS_HIGH()	PORTD |= _BV(SDCARD_CS_PIN)			/* CS=high */
#define MMC_CD		(!(PIND & _BV(SDCARD_INSERTED_PIN)))	/* Card detected.   yes:true, no:false, default:true */
